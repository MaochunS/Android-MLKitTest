...
public class TextGraphic extends GraphicOverlay.Graphic {
  ...
  static public List<Pair<String, RectF>> textAndLocArray = new ArrayList<>();
  ...
  public void draw(Canvas canvas) {
    ...
    for (TextBlock textBlock : text.getTextBlocks()) {
      ...
      for (Line line : textBlock.getLines()) {
        ...
        textAndLocArray.add(new Pair<>(line.getText(), rect));
    ...
    for (Pair<String, RectF> textAndLoc : textAndLocArray){
      Log.d(TAG,  "TxtAndLoc: " + textAndLoc.first + " " + textAndLoc.second);
    }
  }
}
